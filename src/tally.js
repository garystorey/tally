...
( function( $ ) {
  ...
  Tally.prototype = {
    ...
    _bindEvents: function() {
      ...
      self.$el.on( evts, function handleEvent( evt ) {
        $tt.text( evt.type === "focusout" ? "" : self._buildText() );
    ...
    _updateClasses: function( event ) {
      var self = this, $t = self.$tally, $el = $( event.target ),
          etype = event.type, opts = this.options, fld = opts.classes.field,
          warn = opts.warnAt, dir = opts.countDirection,
